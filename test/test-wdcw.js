...
describe('dcm-dfa-connector:setup', function describesConnectorSetup() {
  var setUpComplete,
      URI;
...
describe('dcm-dfa-connector:columnHeaders', function describesConnectorColumnHeaders() {
  var registerHeaders;
/*
...
describe('dcm-dfa-connector:tableData', function describesConnectorTableData() {
  var registerData;
/*
...
describe('dcm-dfa-connector:teardown', function describesConnectorTearDown() {
